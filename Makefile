...
PROJECT_NAME ?= provider-auth0
PROJECT_REPO ?= github.com/jwefers/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= auth0/auth0
export TERRAFORM_PROVIDER_REPO ?= https://github.com/auth0/terraform-provider-auth0
export TERRAFORM_PROVIDER_VERSION ?= 1.14.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-auth0
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/auth0/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
...
REGISTRY_ORGS ?= xpkg.upbound.io/jwefers
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/jwefers
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/jwefers
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-auth0: do.build.images
