...
func (mg *Stream) GetTerraformResourceType() string {
	return "auth0_log_stream"
}

// GetConnectionDetailsMapping for this Stream
func (tr *Stream) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"sink[*].datadog_api_key": "sink[*].datadogApiKeySecretRef", "sink[*].http_authorization": "sink[*].httpAuthorizationSecretRef", "sink[*].mixpanel_service_account_password": "sink[*].mixpanelServiceAccountPasswordSecretRef", "sink[*].segment_write_key": "sink[*].segmentWriteKeySecretRef", "sink[*].splunk_token": "sink[*].splunkTokenSecretRef"}
}
