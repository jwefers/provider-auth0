...
type PermissionsInitParameters struct {
	...
	// (Block Set, Min: 1) List of API permissions granted to the user. (see below for nested schema)
...
// Permissions is the Schema for the Permissionss API. With this resource, you can manage all of a user's permissions.
