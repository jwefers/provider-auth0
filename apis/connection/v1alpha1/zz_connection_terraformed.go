...
func (tr *Connection) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"options[*].client_secret": "options[*].clientSecretSecretRef", "options[*].configuration": "options[*].configurationSecretRef", "options[*].gateway_authentication[*].secret": "options[*].gatewayAuthentication[*].secretSecretRef", "options[*].twilio_token": "options[*].twilioTokenSecretRef"}
}
