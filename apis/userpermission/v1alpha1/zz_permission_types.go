...
type PermissionInitParameters struct {
	...
	// (String) ID of the user to associate the permission to.
...
// Permission is the Schema for the Permissions API. With this resource, you can manage user permissions.
