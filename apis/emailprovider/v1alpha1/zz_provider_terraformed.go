...
func (mg *Provider) GetTerraformResourceType() string {
	return "auth0_email_provider"
}

// GetConnectionDetailsMapping for this Provider
func (tr *Provider) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"credentials[*].access_key_id": "credentials[*].accessKeyIdSecretRef", "credentials[*].api_key": "credentials[*].apiKeySecretRef", "credentials[*].azure_cs_connection_string": "credentials[*].azureCsConnectionStringSecretRef", "credentials[*].ms365_client_id": "credentials[*].ms365ClientIdSecretRef", "credentials[*].ms365_client_secret": "credentials[*].ms365ClientSecretSecretRef", "credentials[*].ms365_tenant_id": "credentials[*].ms365TenantIdSecretRef", "credentials[*].secret_access_key": "credentials[*].secretAccessKeySecretRef", "credentials[*].smtp_pass": "credentials[*].smtpPassSecretRef"}
}
